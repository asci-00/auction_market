...
- Current mobile UX and localization implementation details:
  ...
  - Home, search, orders, notifications, and activity quiet states now attach direct recovery actions such as provider retry, signed-in return routing, or browse recovery instead of leaving the user on a static unavailable panel.
