...
import { Order, OrderFees, UserPenaltyStats } from './models.js';

export function buildOrderFees(finalPrice: number): OrderFees {
...
export function applyUnpaidPenalty(
  stats: UserPenaltyStats,
  finalPrice: number,
): UserPenaltyStats & { forfeited: number } {
