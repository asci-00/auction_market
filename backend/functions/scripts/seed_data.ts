...
export async function seedEmulator(
  ...
  const orders: Array<{
    ...
    },
    {
      ...
      method: 'CARD',
      approvedAt: ago(79),
      lastWebhookEventId: 'evt_confirmed_auction-ended-shipped',
      carrierCode: 'HANJIN',
      carrierName: 'Hanjin',
    ...
    },
    {
      ...
      method: null,
      approvedAt: null,
      lastWebhookEventId: 'evt_cancel_unpaid_auction-unsold',
      carrierCode: null,
      carrierName: null,
      trackingNumber: null,
      trackingUrl: null,
  ...
  const notifications: Array<{
    ...
    },
    {
      ...
      body: 'order-paid 주문을 발송 처리해 주세요.',
      deeplink: 'app://orders/order-paid',
      isRead: false,
      createdAt: ago(24),
    },
