...
abstract class AppLocalizations {
  ...
  /// No description provided for @auctionDetailCategoryJewelry.
  ///
  /// In en, this message translates to:
  /// **'Jewelry'**
  String get auctionDetailCategoryJewelry;

  /// No description provided for @auctionDetailCategoryPhotoCard.
  ///
  /// In en, this message translates to:
  /// **'Photo card'**
  String get auctionDetailCategoryPhotoCard;

  /// No description provided for @auctionDetailCategoryGameConsole.
  ///
  /// In en, this message translates to:
  /// **'Game console'**
  String get auctionDetailCategoryGameConsole;

  /// No description provided for @auctionDetailCategoryFigure.
  ///
  /// In en, this message translates to:
  /// **'Figure'**
  String get auctionDetailCategoryFigure;
  ...
  /// No description provided for @ordersPaymentLaunchAction.
  ///
  /// In en, this message translates to:
  /// **'Open Toss checkout'**
  String get ordersPaymentLaunchAction;
  ...
  /// No description provided for @ordersPaymentLaunchingOverlay.
  ///
  /// In en, this message translates to:
  /// **'Preparing Toss checkout.'**
  String get ordersPaymentLaunchingOverlay;

  /// No description provided for @ordersPaymentLaunchStarted.
  ///
  /// In en, this message translates to:
